...
public class CustomAdapter extends ArrayAdapter<NotiFormat>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView RecieverAddress=(TextView)convertView.findViewById(R.id.RecieverAddress);
        ...
        RecieverAddress.setText("To--"+notification.getBranch()+" "+notification.getYear()+" "+notification.getSection());
